...
pub fn build_denial_payload(request: &ToolRequest, trigger: DenialTrigger) -> ToolDeniedResponse {
    ...
    match trigger {
        DenialTrigger::BlockedPath {
            ...
            let (reason, risk_category, user_instructions, checklist) =
                if matched_pattern.contains(".ssh") || matched_pattern.contains("Keychains") {
                    (
                        "Credential-bearing paths are blocked by Guardrail policy.".to_string(),
                    ...
                    (
                        "Secret-bearing environment files are blocked by Guardrail policy.".to_string(),
                        DenialRiskCategory::Secrets,
        ...
        DenialTrigger::DangerousShellCommand {
            ...
            reason: "Destructive or privileged shell commands are blocked by Guardrail policy.".to_string(),
        ...
        DenialTrigger::ShellExecutionDisabled { target_summary } => ToolDeniedResponse {
            ...
            request_id,
            action_kind: ToolRequestKind::ShellCommand,
            reason: "Shell execution is not enabled in the current Guardrail runtime.".to_string(),
            risk_category: DenialRiskCategory::Shell,
        ...
        DenialTrigger::NetworkDisabled { target_summary } => ToolDeniedResponse {
            ...
            reason: "Network-capable tooling is disabled in the current Guardrail policy and runtime.".to_string(),
...
pub fn build_execution_failure(
    ...
    ToolDeniedResponse {
        ...
        risk_category: DenialRiskCategory::Filesystem,
        user_instructions: "Check that the path exists and is writable locally before retrying. Guardrail will not guess around missing files or broken paths.".to_string(),
        checklist: vec![
